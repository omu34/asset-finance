@php
    use Carbon\Carbon;
    $items = App\Models\News::orderBy('created_at', 'asc')->get();
@endphp
<div class="bg-white bg-center py-12 sm:py-16">
    <div class="mx-auto lg:px-0 px-10 max-w-5xl">
        <div class="mx-auto flex flex-col items-center sm:flex-row sm:justify-between mb-8 ">
            <h2 class="text-3xl font-bold tracking-tight lg:pb-0 pb-5 text-gray-900 sm:text-3xl">Latest News</h2>
...
{{--  @php
    use Carbon\Carbon;
    $items = App\Models\LatestNews::orderBy('created_at', 'asc')->get();
@endphp
<div class="bg-white bg-center py-12 sm:py-16">
    <div class="mx-auto lg:px-0 px-10 max-w-5xl">
        <div class="mx-auto flex flex-col items-center sm:flex-row sm:justify-between mb-8 ">
